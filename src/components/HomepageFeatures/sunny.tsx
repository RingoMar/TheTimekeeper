...
import AviSunny from "@site/static/img/Sunny.png";
    ...
    <div className={clsx(styles.channelHeader)}>
      <div className={clsx(styles.avatarSection)}>
        ...
        >
          ...
          >
            <a href="https://twitch.tv/feelssunnyman">
      ...
      <div className={clsx(styles.channelInfo)}>
        <a href="https://twitch.tv/feelssunnyman">
          <div className={clsx(styles.channelDetails)}>
            <span className={clsx(styles.channelName)}>FeelsSunnyMan</span>
        ...
        <p className={clsx(styles.followerCount)}>100k+ Mod Actions</p>
      </div>
    </div>
  );
};

export default SunnyUse;
